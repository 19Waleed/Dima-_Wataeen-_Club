<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form_Notifications.aspx.cs" Inherits="Dima__Wataeen__Club.Form_Notifications" %>
...
<div class="row center page single" style="height: 43px; width: 98%; background-color: #CA9662;">
  ...
  <div class="col-md-4 box3-container" style="right: -28px; top: -560px">
     
  </div>
           <div class="box3">
              <h3><span></span>Subscribe to club news and receive new events</h3>
               <p>Enter your email to receive new news</p>
               <form1>
